...
def render(img_rgb):
    ...
    num_Down = 2  # number of downscaling steps
    num_Bilateral_Filters = 100  # number of bilateral filtering steps
...
class Cartoonizer:
    ...
    The class uses a bilateral filter and adaptive thresholds to create
    a cartoon effect.
    """
...
file_name = "FJIMG_20200418_123839-01.jpeg"  # File_name will come here
